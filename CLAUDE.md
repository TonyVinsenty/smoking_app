...
Next: owner tests «Я закурил(а)» + history → Knowledge tab → Settings «Мои данные» (edit products) → notifications → craving-map stats. Labels use gender-neutral forms («Я закурил(а)», «Тяга прошла!»).
