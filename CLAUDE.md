...
Next: Settings «Мои данные» (edit products of current attempt via `db.replaceProducts`) → notifications → craving-map stats. Labels use gender-neutral forms («Я закурил(а)», «Тяга прошла!»).
